// =============================================================================
// VoyYa Pasajero — Almacén seguro de sesión (expo-secure-store)
// -----------------------------------------------------------------------------
// Envoltorio fino sobre expo-secure-store (Keychain/Keystore nativo — NUNCA
// AsyncStorage para tokens). Responsabilidad única: leer/escribir/borrar las
// claves de sesión. `usuario` se persiste ADEMÁS de los tokens porque el
// contrato de @voyya/shared no expone un `GET /auth/me`: sin esto, la app no
// podría repintar nombre/rol/perfil_completo al reabrir sin pedir login otra
// vez (decisiones-construccion-autenticacion.md D-A04).
// =============================================================================
