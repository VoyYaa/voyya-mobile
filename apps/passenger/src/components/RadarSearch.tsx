// =============================================================================
// VoyYa Pasajero — RadarSearch
// -----------------------------------------------------------------------------
// Anillo animado de "buscando conductor" (P6). Decorativo (aria-hidden) — el
// estado se comunica por texto en la pantalla, no por la animación
// (pasajero-estados-borde.md §3.6). Con `prefers-reduced-motion` cae a un
// anillo ESTÁTICO sin pulso, nunca "a medias" (§3.3).
// =============================================================================

import React, { useEffect, useRef } from 'react';
import { Animated, Text, View } from 'react-native';
import { useReducedMotion, useTheme } from '@voyya/ui-mobile';
