// =============================================================================
// VoyYa Pasajero — Root layout (expo-router)
// -----------------------------------------------------------------------------
...
// monta UNA vez aquí para que Home/Buscando/Conductor-asignado compartan el
// mismo banner "sin conexión" (pasajero-estados-borde.md §6.1).
//
