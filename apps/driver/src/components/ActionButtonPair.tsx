// =============================================================================
// VoyYa Conductor — ActionButtonPair
// -----------------------------------------------------------------------------
// Aceptar/Rechazar (§1.3/§3.5). NO se agrega un variant nuevo a
// `packages/ui-mobile` Button (la tarea escopa el único componente nuevo de ese
// paquete a `CountdownRing`): se construye local con los MISMOS tokens
// (radius.button, spacing, typography.button) para verse/comportarse igual.
//
// Rechazar = secundario (fondo `dangerTint`, texto `text`) · Aceptar = primario
// (fondo `brand`, texto `onBrand` — espresso, NUNCA blanco: no alcanza AA sobre
// ámbar). Ambos 48px (> mínimo 44px), nombres accesibles explícitos ("Aceptar
// solicitud"/"Rechazar solicitud" — no solo "Aceptar"/"Rechazar" a secas).
// =============================================================================
