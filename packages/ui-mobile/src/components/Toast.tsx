// =============================================================================
// VoyYa — Toast (packages/ui-mobile)
// -----------------------------------------------------------------------------
// Confirmación breve no bloqueante (p.ej. "Solicitud cancelada."). Añadido más
// allá de la lista base porque el copy de éxito de pasajero-estados-borde.md
// (§3.4, §7.1-7.3) lo exige sin bloquear con un modal. `accessibilityLiveRegion`
// para que se anuncie una sola vez; se autooculta.
// =============================================================================
