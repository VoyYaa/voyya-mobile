// =============================================================================
// VoyYa — StatePanel (interno; packages/ui-mobile)
// -----------------------------------------------------------------------------
// Base compartida de EmptyState/ErrorState (DRY): layout ícono + título + cuerpo
// + acciones. No se exporta desde el barrel público: es un detalle interno.
// =============================================================================
...
export interface StatePanelProps {
  ...
  /** `alert` cuando el estado exige una decisión (error); `none` cuando es solo informativo (vacío). */
